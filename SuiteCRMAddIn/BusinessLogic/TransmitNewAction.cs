...
namespace SuiteCRMAddIn.BusinessLogic
{
    ...
    public class TransmitNewAction<OutlookItemType> : DaemonAction
        where OutlookItemType : class
    {
        private string crmType;
        private OutlookItemType olItem;
        private Synchroniser<OutlookItemType> synchroniser;

        public TransmitNewAction(Synchroniser<OutlookItemType> synchroniser, OutlookItemType olItem, string crmType)
        {
            this.olItem = olItem;
        ...
        public void Perform()
        {
            this.synchroniser.AddOrUpdateItemFromOutlookToCrm(olItem, this.crmType);
        }
    }
}
