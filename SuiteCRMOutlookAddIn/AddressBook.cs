...
namespace SuiteCRMOutlookAddIn
{
    public partial class frmAddressBook : Form
    {
        ...
        public frmAddressBook()
        {
            ...
            AddinModule.CurrentInstance.SugarCRMAuthenticate();
            if (AddinModule.CurrentInstance.SugarCRMUserSession.id=="")
            {
                MessageBox.Show("Unable to authenticate", "Error");
                base.Close();
            }
        }
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            try
            {
                MailItem currentItem = (MailItem)AddinModule.CurrentInstance.OutlookApp.ActiveInspector().CurrentItem;
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (string str2 in strArray2)
                {
                    ...
                    {
                        string str8 = query;
                        query = str8 + "AND " + str2.ToLower() + ".assigned_user_id = '" + AddinModule.CurrentInstance.SugarCRMUserSession.id + "'";
                    }
